...
2. Also in the r code, create a horizontal bar plot of parameter estimates. Sort them from largest to smallest first and drop the intercept. From a fitted model use pull_workload_fit() %>% tidy() to get the parameter estimates.
